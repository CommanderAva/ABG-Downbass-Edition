/obj/item/weapon/gun
	...
	attack_verb = null
	sprite_sheet_id = 1
	var/pikantini = 0 //so we can actually attach pikantini rails to any gun. Muh tacticoolness
	...
	var/obj/item/attachable/siderail = null
...
/obj/item/weapon/gun/proc/toggle_scope(mob/user)
	zoom(user, 11, 12)
