...
/obj/item/ammo_magazine/ak74
	name = "AK-74 magazine (5.45x39)"
	desc = "A 5.45mm AK-74 assault rifle magazine. Made from Bakelite"
	caliber = "5.45x39mm"
	icon_state = "5.45x39mm"
	w_class = 3
	default_ammo = /datum/ammo/bullet/rifle/a545x39
	max_rounds = 30
	gun_type = /obj/item/weapon/gun/rifle/ak74
